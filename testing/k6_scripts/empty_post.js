...
export default function () {
    let connectionUrl = `${apiHost}/v1/test/empty_post`;
    ...
    let res = http.post(connectionUrl, payload, {
        headers: {
...
export function handleSummary(data) {
    ...
    const filename = `json_results/empty_post_VU_${options.vus}_${filenamePrefix}.json`;
