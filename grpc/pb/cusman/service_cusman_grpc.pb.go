...
const (
	...
	CustomerManagementService_VerifyCustomerEmail_FullMethodName = "/cusman.CustomerManagementService/VerifyCustomerEmail"
...
type CustomerManagementServiceClient interface {
	...
	VerifyCustomerEmail(ctx context.Context, in *customer.VerifyEmailRequest, opts ...grpc.CallOption) (*customer.VerifyEmailResponse, error)
...
func (c *customerManagementServiceClient) VerifyCustomerEmail(ctx context.Context, in *customer.VerifyEmailRequest, opts ...grpc.CallOption) (*customer.VerifyEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(customer.VerifyEmailResponse)
	err := c.cc.Invoke(ctx, CustomerManagementService_VerifyCustomerEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerManagementServiceServer interface {
	...
	VerifyCustomerEmail(context.Context, *customer.VerifyEmailRequest) (*customer.VerifyEmailResponse, error)
...
func (UnimplementedCustomerManagementServiceServer) VerifyCustomerEmail(context.Context, *customer.VerifyEmailRequest) (*customer.VerifyEmailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerifyCustomerEmail not implemented")
}
...
func _CustomerManagementService_VerifyCustomerEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(customer.VerifyEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerManagementServiceServer).VerifyCustomerEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerManagementService_VerifyCustomerEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerManagementServiceServer).VerifyCustomerEmail(ctx, req.(*customer.VerifyEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CustomerManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerifyCustomerEmail",
			Handler:    _CustomerManagementService_VerifyCustomerEmail_Handler,
		},
		{
